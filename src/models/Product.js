// ============================================
// PRODUCT MODEL
// Model cho sản phẩm với variants
// ============================================
 ...
 * Sub-schema cho từng biến thể của sản phẩm
 * 
 * Ví dụ:
 * - Áo thun: Size S/M/L, Color Red/Blue
 * - Điện thoại: Storage 64GB/128GB, Color Black/White
 */
const productVariantSchema = new mongoose.Schema({
    ...
    timestamps: true,
    _id: true // Giữ _id cho variant để có thể reference
});
...
/**
 * INDEXES
 * Tạo indexes để tối ưu search và query performance
 */
...
/**
 * STATIC METHODS
 * Methods gọi trên Model (Product.method())
 */
...
/**
 * INSTANCE METHODS
 * Methods gọi trên document (product.method())
 */
