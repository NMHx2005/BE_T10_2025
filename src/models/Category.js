...
categorySchema.post('save', async function() {
    ...
    this.productCount = directProductCount + descendantProductCount;
    await this.save();
    
    // Cập nhật productCount cho tất cả ancestors
    const ancestors = await mongoose.model('Category').findAllAncestors(this._id);
    for (const ancestor of ancestors) {
        ...
        const ancestorDescendants = await mongoose.model('Category').findAllDescendants(ancestor._id);
        ...
        ancestor.productCount = ancestorDirectCount + ancestorDescendantCount;
        await ancestor.save();
    }
});
